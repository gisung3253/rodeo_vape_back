...
*사용자 인증을 위한 로그인 인터페이스*

### 판매 장부 화면
![판매 장부](./images/SALES.png)
*일일 판매 내역 및 새로운 판매 기록 추가*

### 재고 확인 화면
![재고 확인](./images/INVEN.png)
*카테고리별 재고 상태 및 재고 부족 알림*

### 월별 통계 화면
![월별 통계](./images/MONTH.png)
*월간 매출 그래프 및 주요 통계*

### 메모 관리 화면
![메모 관리](./images/MEMO.png)
*매장 관리를 위한 메모 작성 및 조회*

### 재고 상품 추가/수정
![재고 상품 관리](./images/INVENMAN.png)
*새 상품 추가 및 기존 상품 정보 수정 인터페이스*
